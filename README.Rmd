...
- **Supports Swiss Ornithological Institute Data**: Special functions have been designed to deal with internal SOI data. 
- **Built on frictionless-r**: This package is built using the `frictionless-r` package, adhering to the Frictionless Data standards for open data. 
