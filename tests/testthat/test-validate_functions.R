...
test_that("check_type function validates datetime types correctly", {
  ...
  expect_true(check_type(c("2023-12-25T10:30:45Z", "2024-01-01T00:00:00Z"), "datetime", "test_field"))
...
test_that("check_type function validates specialized types correctly", {
  ...
  # GeoJSON types
  valid_geojson <- '{"type": "Feature", "geometry": {"type": "Point", "coordinates": [0, 0]}, "properties": {}}'
